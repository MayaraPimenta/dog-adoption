...
### Critérios de aceite
- [ ] Exibe foto, nome, raça e idade
- [ ] Arrasto > 80px para direita emite swipe-right
- [ ] Arrasto > 80px para esquerda emite swipe-left
- [ ] Card retorna ao centro se arrasto < 80px
